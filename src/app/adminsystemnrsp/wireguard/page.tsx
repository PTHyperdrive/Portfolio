...
export default function AdminWireGuardPage() {
    ...
    const tabStyle = (id: string): React.CSSProperties => ({
        padding: "8px 18px", borderRadius: t.isMono ? 0 : 8,
        ...
        <div style={{ padding: "32px 36px", minHeight: "100vh", backgroundColor: t.bgPrimary }}>
            ...
            <div style={{ marginBottom: 28 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <button onClick={loadData} style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textMuted, fontSize: "0.8rem", cursor: "pointer" }}>
