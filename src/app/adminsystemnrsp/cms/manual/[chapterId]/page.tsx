                ...
                <div style={{ padding: 10, borderTop: `1px solid ${t.borderPrimary}` }}>
                    {showNewSection ? (
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                            ...
                            <div style={{ display: "flex", gap: 6 }}>
                                <button onClick={handleCreateSection} disabled={!newTitle.trim() || saving} style={{
                                    flex: 1, padding: "6px", borderRadius: t.isMono ? 4 : 6, border: "none",
                                ...
                                <button onClick={() => { setShowNewSection(false); setNewTitle(""); }} style={{
                                    padding: "6px 10px", borderRadius: t.isMono ? 4 : 6,
                        ...
                        <button onClick={() => setShowNewSection(true)} style={{
                            ...
                            gap: 6, padding: "8px", borderRadius: t.isMono ? 4 : 6,
                ...
                {!selectedId ? (
                    ...
                    <div style={{ maxWidth: 840 }}>
                        ...
                        <div style={{
                            ...
                            borderRadius: `${t.isMono ? 4 : 8}px ${t.isMono ? 4 : 8}px 0 0`,
                            ...
                            {[
                                ...
                                <button key={title} onClick={action} title={title} style={{
                                    width: 30, height: 28, borderRadius: t.isMono ? 3 : 5,
                        ...
                        <textarea
                            ...
                            style={{
                                ...inputStyle,
                                borderRadius: `0 0 ${t.isMono ? 4 : 8}px ${t.isMono ? 4 : 8}px`,
