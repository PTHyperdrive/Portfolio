...
export default function AdminSettingsPage() {
    ...
    const inp: React.CSSProperties = { background: t.bgInput, border: `1px solid ${t.borderPrimary}`, borderRadius: t.isMono ? 0 : 8, color: t.textPrimary, fontSize: "0.875rem", outline: "none", padding: "9px 12px", fontFamily: t.fontFamily, width: "100%", boxSizing: "border-box" as const };
    ...
    return (
        <div style={{ padding: "32px 36px", minHeight: "100vh", backgroundColor: t.bgPrimary }}>
            ...
            {/* Toasts */}
            {success && <div style={{ padding: "10px 16px", borderRadius: t.isMono ? 0 : 8, background: t.statusSuccessBg, border: `1px solid ${t.statusSuccess}33`, color: t.statusSuccess, marginBottom: 16, fontSize: "0.875rem", display: "flex", alignItems: "center", gap: 8 }}><CheckCircle2 style={{ width: 14, height: 14 }} />{success}</div>}
            {error && <div style={{ padding: "10px 16px", borderRadius: t.isMono ? 0 : 8, background: t.statusErrorBg, border: `1px solid ${t.statusError}33`, color: t.statusError, marginBottom: 16, fontSize: "0.875rem", display: "flex", alignItems: "center", gap: 8 }}><AlertCircle style={{ width: 14, height: 14 }} />{error}</div>}
