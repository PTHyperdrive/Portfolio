...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const linkStyle = (href: string): React.CSSProperties => {
        ...
        return {
            ...
            padding: "8px 12px", borderRadius: t.isMono ? 0 : 8,
            ...
            <aside style={{
                ...
                <div style={{ padding: "8px 8px 0" }}>
                    <Link href="/dashboard/vps" style={{
                        ...
                        borderRadius: t.isMono ? 0 : 8, textDecoration: "none",
                ...
                <div style={{ padding: "10px 12px 14px", borderTop: `1px solid ${t.borderPrimary}`, flexShrink: 0 }}>
                    ...
                    <div style={{
                        ...
                        padding: "7px 10px", borderRadius: t.isMono ? 0 : 8,
                    ...
                    {session?.user && (
                        <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 8 }}>
                            <div style={{
                                width: 28, height: 28, borderRadius: t.isMono ? 0 : 7,
                            ...
                            <button onClick={() => signOut({ callbackUrl: "/" })} title="Sign out" style={{
                                width: 26, height: 26, borderRadius: t.isMono ? 0 : 6, flexShrink: 0,
