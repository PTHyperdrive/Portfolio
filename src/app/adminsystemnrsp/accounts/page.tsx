            ...
            <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                        {selected.size > 0 && (
                            <button onClick={openDeleteModal} style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.statusError}40`, background: `${t.statusError}15`, color: t.statusError, fontSize: "0.8rem", fontWeight: 600, cursor: "pointer", transition: "all 0.15s" }}>
                                    ...
                                    <tr
                                        ...
                                        <td style={{ padding: "12px 16px" }}>
                                            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                                <div style={{ width: 30, height: 30, borderRadius: t.isMono ? 0 : 8, background: t.accentPrimaryMuted, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: "0.75rem", color: t.accentPrimary, flexShrink: 0 }}>
                                        ...
                                        <td style={{ padding: "12px 16px" }}>
                                            <button
                                                ...
                                                style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "3px 8px", borderRadius: t.isMono ? 0 : 6, border: `1px solid ${t.borderPrimary}`, background: "transparent", cursor: "pointer", fontFamily: t.fontMono, fontSize: "0.82rem", color: t.statusSuccess }}
                                            >
                                        ...
                                        <td style={{ padding: "12px 16px" }}>
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    width: 28, height: 28, borderRadius: t.isMono ? 0 : 6,
                                    ...
                                    {expanded === user.id && user.vpsInstances.length > 0 && (
                                        <tr key={`${user.id}-exp`}>
                                            <td colSpan={11} style={{ padding: "0 16px 14px", background: t.bgSecondary }}>
                                                <div style={{ padding: "12px 14px", borderRadius: t.isMono ? 0 : 8, background: t.bgTertiary, border: `1px solid ${t.borderSecondary}` }}>
                                                    ...
                                                    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                                        {user.vpsInstances.map(vm => (
                                                            <div key={vm.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 10px", borderRadius: t.isMono ? 0 : 6, background: t.bgCard }}>
                ...
                <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.55)", backdropFilter: "blur(4px)" }} onClick={() => setCrModal(null)}>
                    <div onClick={e => e.stopPropagation()} style={{ ...card, padding: "28px 32px", maxWidth: 420, width: "90%", position: "relative" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
                            <button onClick={() => setCrModal(null)} style={{ padding: "7px 16px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textMuted, fontSize: "0.8rem", cursor: "pointer" }}>Cancel</button>
                            <button
                                onClick={adjustCredits}
                                disabled={crSaving || !crDelta}
                                style={{ padding: "7px 16px", borderRadius: t.isMono ? 0 : 8, border: "none", background: crDelta ? t.accentPrimary : `${t.textMuted}40`, color: "#fff", fontSize: "0.8rem", fontWeight: 600, cursor: crDelta ? "pointer" : "not-allowed" }}
                            >
            ...
            {pwModal && (
                <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.55)", backdropFilter: "blur(4px)" }} onClick={() => setPwModal(null)}>
                    <div onClick={e => e.stopPropagation()} style={{ ...card, padding: "28px 32px", maxWidth: 420, width: "90%", position: "relative" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
                            <button onClick={() => setPwModal(null)} style={{ padding: "7px 16px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textMuted, fontSize: "0.8rem", cursor: "pointer" }}>Cancel</button>
                            <button
                                onClick={resetPassword}
                                disabled={pwSaving || newPw.length < 8}
                                style={{
                                    padding: "7px 16px", borderRadius: t.isMono ? 0 : 8, border: "none",
            ...
            {deleteModal && (
                <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.55)", backdropFilter: "blur(4px)" }} onClick={closeDeleteModal}>
                    <div onClick={e => e.stopPropagation()} style={{ ...card, padding: "28px 32px", maxWidth: 480, width: "90%", position: "relative" }}>
                        ...
                        <div style={{ maxHeight: 180, overflowY: "auto", marginBottom: 16, padding: "10px 12px", borderRadius: t.isMono ? 0 : 8, background: t.bgSecondary, border: `1px solid ${t.borderSecondary}` }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
                            <button onClick={closeDeleteModal} style={{ padding: "9px 20px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textMuted, fontSize: "0.82rem", cursor: "pointer" }}>Cancel</button>
                            <button
                                onClick={handleBulkDelete}
                                disabled={countdown > 0 || deleting}
                                style={{
                                    padding: "9px 20px", borderRadius: t.isMono ? 0 : 8, border: "none",
