            ...
            <div style={{ width: 380, padding: "36px 32px", background: t.bgCard, border: `1px solid ${t.borderPrimary}`, borderRadius: t.cardRadius, boxShadow: t.shadow, textAlign: "center" }}>
                ...
                <form onSubmit={e => { e.preventDefault(); isSetup ? setup() : unlock(); }}>
                    <div style={{ position: "relative", marginBottom: 12 }}>
                        <input ref={ref} type={show ? "text" : "password"} value={pin} onChange={e => setPin(e.target.value)} placeholder={isSetup ? "Create PIN (4+)" : "Enter PIN"} autoComplete="off" style={{ width: "100%", boxSizing: "border-box", padding: "11px 40px 11px 14px", background: t.bgInput, border: `1px solid ${err ? t.statusError : t.borderPrimary}`, borderRadius: t.isMono ? 4 : 8, color: t.textPrimary, fontSize: "0.95rem", outline: "none", fontFamily: t.fontMono, letterSpacing: "0.12em", textAlign: "center" }} />
                    ...
                    {isSetup && <input type={show ? "text" : "password"} value={pinC} onChange={e => setPinC(e.target.value)} placeholder="Confirm PIN" style={{ width: "100%", boxSizing: "border-box", padding: "11px 14px", background: t.bgInput, border: `1px solid ${t.borderPrimary}`, borderRadius: t.isMono ? 4 : 8, color: t.textPrimary, fontSize: "0.95rem", outline: "none", fontFamily: t.fontMono, letterSpacing: "0.12em", textAlign: "center", marginBottom: 12 }} />}
            ...
            <div style={{ marginBottom: 28 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        {adminPrivKey && (
                            <button onClick={handleLock} style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", borderRadius: t.isMono ? 4 : 8, border: `1px solid ${t.statusSuccess}44`, background: t.statusSuccessBg, color: t.statusSuccess, fontSize: "0.8rem", fontWeight: 700, cursor: "pointer" }}>
                    ...
                    {!selectedId ? (
                        ...
                        <>
                            ...
                            <div style={{ padding: "14px 20px", borderBottom: `1px solid ${t.borderSecondary}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                    {!detail.closed && (
                                        <button onClick={closeChat} disabled={toggling} style={{ padding: "5px 12px", borderRadius: t.isMono ? 4 : 6, border: `1px solid ${t.borderPrimary}`, background: t.statusErrorBg, color: t.statusError, fontSize: "0.75rem", fontWeight: 700, cursor: "pointer" }}>
