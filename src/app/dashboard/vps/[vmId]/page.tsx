...
export default function VmDetailPage({ params }: { params: Promise<{ vmId: string }> }) {
    ...
    return (
        <div style={{ padding: "32px 36px", minHeight: "100vh", backgroundColor: t.bgPrimary }}>
            ...
            {error && (
                <div style={{ padding: "12px 18px", borderRadius: t.isMono ? 0 : 8, background: t.statusErrorBg, border: `1px solid ${t.statusError}33`, color: t.statusError, marginBottom: 20, fontSize: "0.88rem" }}>
            ...
            {tab === "settings" && (
                <div>
                    ...
                    <div style={{ ...card, marginBottom: 20 }}>
                        ...
                        {isRunning && (
                            <div style={{ padding: "12px 16px", borderRadius: t.isMono ? 0 : 8, background: t.statusWarningBg, border: `1px solid ${t.statusWarning}33`, color: t.statusWarning, fontSize: "0.85rem", fontWeight: 600, marginBottom: 16, display: "flex", alignItems: "center", gap: 8 }}>
                        ...
                        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                            {(["novnc", "spice"] as const).map(opt => (
                                <label key={opt} style={{
                                    flex: 1, minWidth: 160, padding: "14px 18px", borderRadius: t.isMono ? 0 : 8,
                    ...
                    <div style={{ ...card, marginBottom: 20 }}>
                        ...
                        <div style={{ display: "flex", gap: 12, alignItems: "flex-end", flexWrap: "wrap" }}>
                            <div style={{ flex: 1, minWidth: 250 }}>
                                ...
                                <select value={selectedIso} onChange={e => setSelectedIso(e.target.value)} style={{ width: "100%", padding: "9px 12px", borderRadius: t.isMono ? 0 : 8, background: t.bgInput, border: `1px solid ${t.borderPrimary}`, color: t.textPrimary, fontSize: "0.875rem", cursor: "pointer", outline: "none" }}>
                    ...
                    <div style={{ ...card, marginBottom: 24 }}>
                        ...
                        <div style={{ fontSize: "0.82rem", color: t.textMuted, padding: 16, background: t.bgSecondary, borderRadius: t.isMono ? 0 : 8, fontFamily: t.fontMono }}>
                ...
                <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: t.isLight ? "rgba(0,0,0,0.4)" : "rgba(0,0,0,0.7)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
                    <div style={{ ...card, width: "100%", maxWidth: 480, padding: 32, border: `1px solid ${t.statusError}55`, boxShadow: `0 10px 40px ${t.statusError}22` }}>
                        ...
                        <form onSubmit={handleDestroy}>
                            ...
                            <input type="password" required value={destroyPwd} onChange={e => setDestroyPwd(e.target.value)} placeholder="••••••••" style={{ width: "100%", marginBottom: 16, padding: "10px 12px", borderRadius: t.isMono ? 0 : 8, background: t.bgSecondary, border: `1px solid ${t.borderPrimary}`, color: t.textPrimary, fontSize: "0.875rem", outline: "none", boxSizing: "border-box" }} />
