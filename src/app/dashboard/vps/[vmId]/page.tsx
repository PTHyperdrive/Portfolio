            ...
            <div style={{ marginBottom: 28 }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 14, flexWrap: "wrap", gap: 16 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                        {isRunning ? (
                            <>
                                <button onClick={() => handleAction("restart")} disabled={!!actionLoading} style={{ padding: "8px 16px", borderRadius: t.buttonRadius, border: `1px solid ${t.borderPrimary}`, background: t.bgCard, color: t.textSecondary, cursor: "pointer", fontSize: "0.85rem", fontWeight: 600 }}>{actionLoading === "restart" ? "…" : "Restart"}</button>
