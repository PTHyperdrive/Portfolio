...
export default function VpsDashboard() {
    ...
    const inputStyle: React.CSSProperties = {
        ...
        borderRadius: t.cardRadius, color: t.textPrimary, fontSize: "0.85rem", outline: "none",
    ...
    const renderPagination = () => {
        ...
        const pb = (active: boolean, disabled?: boolean): React.CSSProperties => ({
            minWidth: 34, height: 34, padding: "0 10px", borderRadius: t.cardRadius,
    ...
    return (
        <div style={{ padding: "32px 36px", minHeight: "100vh", backgroundColor: t.bgPrimary }}>
            ...
            {trialStatus?.isPastGrace && (
                <div style={{ padding: "14px 20px", borderRadius: t.cardRadius, background: t.statusErrorBg, border: `1px solid ${t.statusError}33`, color: t.statusError, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            {trialStatus?.isExpired && !trialStatus.isPastGrace && (
                <div style={{ padding: "14px 20px", borderRadius: t.cardRadius, background: t.statusWarningBg, border: `1px solid ${t.statusWarning}33`, color: t.statusWarning, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            {trialStatus?.isActive && (
                <div style={{ padding: "12px 20px", borderRadius: t.cardRadius, background: t.statusSuccessBg, border: `1px solid ${t.statusSuccess}22`, color: t.statusSuccess, marginBottom: 20, fontSize: "0.85rem" }}>
            ...
            {/* ── Error Banner ── */}
            {error && (
                <div style={{ padding: "12px 16px", borderRadius: t.buttonRadius, background: t.statusErrorBg, border: `1px solid ${t.statusError}33`, color: t.statusError, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between" }}>
                    {error}
            ...
            <div style={card}>
                ...
                <div style={{ padding: "16px 20px", borderBottom: `1px solid ${t.borderSecondary}`, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                    ...
                    <div style={{ flex: "0 0 auto", marginLeft: "auto" }}>
                        <button onClick={() => loadInstances()} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "7px 14px", borderRadius: t.buttonRadius, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textMuted, fontSize: "0.8rem", cursor: "pointer" }}>
                ...
                {loading ? (
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "50vh", textAlign: "center", padding: "60px 40px" }}>
                        <div style={{ width: 96, height: 96, borderRadius: t.cardRadius, background: t.accentPrimaryMuted, border: `1px solid ${t.accentPrimary}33`, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 28px" }}>
                            {hasFilters
                                            ...
                                            >
                                                ...
                                                <td style={{ padding: "16px 20px" }}>
                                                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                                        <div style={{ width: 24, height: 24, borderRadius: t.buttonRadius, background: t.accentPrimaryMuted, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                                                ...
                                                <td style={{ padding: "16px 20px" }}>
                                                    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                                                        {isRunning ? (
                                                            <>
                                                                <Link href={`/dashboard/vps/${vm.vmId}?node=${vm.node}&tab=console`} title="Console"
                                                                    style={{ width: 32, height: 32, borderRadius: t.buttonRadius, display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid ${t.accentPrimary}44`, background: t.accentPrimaryMuted, color: t.accentPrimary, textDecoration: "none" }}>
                                                                ...
                                                                <button title="Restart (graceful reboot)" disabled={actionLoading === `${vm.vmId}-restart`} onClick={() => handleAction(vm.vmId, vm.node, "restart")}
                                                                    style={{ width: 32, height: 32, borderRadius: t.buttonRadius, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textSecondary, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                                ...
                                                                <button title="Hard reset (power-cycle)" disabled={actionLoading === `${vm.vmId}-reset`} onClick={() => { if (confirm("Hard reset will power-cycle the VM immediately. Continue?")) handleAction(vm.vmId, vm.node, "reset"); }}
                                                                    style={{ width: 32, height: 32, borderRadius: t.buttonRadius, border: `1px solid ${t.statusWarning}55`, background: "transparent", color: t.statusWarning, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                        ...
                                                        <Link href={`/dashboard/vps/${vm.vmId}?node=${vm.node}`} title="Settings"
                                                            style={{ width: 32, height: 32, borderRadius: t.buttonRadius, display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid ${t.borderPrimary}`, color: t.textMuted, textDecoration: "none" }}>
