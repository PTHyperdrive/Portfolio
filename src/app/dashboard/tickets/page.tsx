...
export default function TicketsPage() {
    ...
    const inputStyle: React.CSSProperties = { background: t.bgInput, border: `1px solid ${t.borderPrimary}`, borderRadius: t.isMono ? 0 : 8, color: t.textPrimary, fontSize: "0.875rem", outline: "none", padding: "9px 13px", width: "100%", boxSizing: "border-box" as const, fontFamily: t.fontFamily };
    ...
    return (
        <div style={{ padding: "32px 36px", minHeight: "100vh", backgroundColor: t.bgPrimary }}>
            ...
            {/* Toasts */}
            {success && <div style={{ padding: "12px 16px", borderRadius: t.isMono ? 0 : 9, background: t.statusSuccessBg, border: `1px solid ${t.statusSuccess}33`, color: t.statusSuccess, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}><span style={{ display: "flex", alignItems: "center", gap: 6 }}><CheckCircle2 style={{ width: 14, height: 14 }} /> {success}</span><button onClick={() => setSuccess("")} style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", display: "flex" }}><X style={{ width: 14, height: 14 }} /></button></div>}
            {error && <div style={{ padding: "12px 16px", borderRadius: t.isMono ? 0 : 9, background: t.statusErrorBg, border: `1px solid ${t.statusError}33`, color: t.statusError, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}><span style={{ display: "flex", alignItems: "center", gap: 6 }}><AlertCircle style={{ width: 14, height: 14 }} /> {error}</span><button onClick={() => setError("")} style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", display: "flex" }}><X style={{ width: 14, height: 14 }} /></button></div>}
                ...
                <form onSubmit={handleSubmit} style={{ ...card, padding: "24px 28px", marginBottom: 24 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                        ...
                        <div>
                            ...
                            <label style={{ display: "flex", alignItems: "center", gap: 8, padding: "12px 18px", borderRadius: t.isMono ? 0 : 8, border: `2px dashed ${t.borderPrimary}`, cursor: "pointer", color: t.textMuted, fontSize: "0.82rem", justifyContent: "center" }}>
                    ...
                    <div style={{ ...card, width: "100%", maxWidth: 680, maxHeight: "85vh", overflowY: "auto", padding: 0 }}>
                        ...
                        <div style={{ padding: 24 }}>
                            ...
                            {selectedTicket.description && (
                                <div style={{ padding: "16px 20px", borderRadius: t.isMono ? 0 : 8, background: t.bgSecondary, border: `1px solid ${t.borderSecondary}`, fontSize: "0.875rem", color: t.textSecondary, lineHeight: 1.7, whiteSpace: "pre-wrap", fontFamily: t.fontMono }}>
                                    {selectedTicket.description}
                                </div>
                            )}
                                    ...
                                    return imgs.length > 0 ? (
                                        <div style={{ marginTop: 16 }}>
                                            ...
                                            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                                                {imgs.map((img, i) => (
                                                    <img key={i} src={`/api/tickets/file/${img}`} alt={`Evidence ${i + 1}`} onClick={() => setLightboxUrl(`/api/tickets/file/${img}`)} style={{ maxWidth: 200, maxHeight: 150, borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, objectFit: "cover", cursor: "pointer", transition: "opacity 0.15s" }} onMouseEnter={e => (e.currentTarget.style.opacity = "0.8")} onMouseLeave={e => (e.currentTarget.style.opacity = "1")} />
                                                ))}
                                            </div>
                                        </div>
                                    ) : null;
                            ...
                            {selectedTicket.resolvedAt && (
                                <div style={{ marginTop: 16, padding: "10px 14px", borderRadius: t.isMono ? 0 : 8, background: t.statusSuccessBg, border: `1px solid ${t.statusSuccess}33`, display: "flex", alignItems: "center", gap: 8 }}>
