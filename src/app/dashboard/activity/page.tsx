            ...
            <div style={card}>
                ...
                <div style={{ padding: "16px 24px", display: "flex", gap: 12, borderBottom: `1px solid ${t.borderSecondary}` }}>
                    <div style={{ position: "relative", flex: 1 }}>
                        ...
                        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search activities..." style={{ width: "100%", paddingLeft: 36, padding: "9px 12px 9px 36px", background: t.bgInput, border: `1px solid ${t.borderPrimary}`, borderRadius: t.isMono ? 0 : 8, color: t.textPrimary, fontSize: "0.875rem", outline: "none", boxSizing: "border-box" }} />
                    </div>
                </div>

                {error && <div style={{ margin: 20, padding: "12px 16px", background: t.statusErrorBg, borderRadius: t.isMono ? 0 : 8, color: t.statusError, fontSize: "0.85rem" }}>{error}</div>}
                                        ...
                                        {isOpen && (
                                            <tr>
                                                <td colSpan={6} style={{ padding: "0 20px 16px", background: t.accentPrimaryMuted }}>
                                                    <div style={{ padding: 20, background: t.bgSecondary, borderRadius: t.isMono ? 0 : 12, border: `1px solid ${t.borderSecondary}` }}>
                                                        ...
                                                        {log.metadata && (
                                                            <div>
                                                                ...
                                                                <pre style={{ padding: 14, background: t.bgTertiary, borderRadius: t.isMono ? 0 : 8, fontSize: "0.78rem", color: t.textSecondary, overflowX: "auto", fontFamily: t.fontMono }}>
                ...
                {totalPages > 1 && (
                    <div style={{ padding: "14px 24px", borderTop: `1px solid ${t.borderSecondary}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <div style={{ display: "flex", gap: 8 }}>
                            <button disabled={page <= 1} onClick={() => load(page - 1)} style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "6px 12px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: page <= 1 ? t.textMuted : t.textPrimary, cursor: page <= 1 ? "not-allowed" : "pointer", fontSize: "0.85rem" }}>
                                <ChevronLeft style={{ width: 16, height: 16 }} />
                            </button>
                            <button disabled={page >= totalPages} onClick={() => load(page + 1)} style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "6px 12px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: page >= totalPages ? t.textMuted : t.textPrimary, cursor: page >= totalPages ? "not-allowed" : "pointer", fontSize: "0.85rem" }}>
