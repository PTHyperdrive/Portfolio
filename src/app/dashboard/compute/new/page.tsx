        ...
        <div style={{ padding: "28px 36px", minHeight: "100vh", backgroundColor: "#0d1117" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 24, alignItems: "start" }}>
                    ...
                    <div style={{ ...card, padding: 24 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                            {PLANS.map(p => {
                                ...
                                const hasTicket = tickets.some(t => t.planId === p.id);
                                return (
                            ...
                            {PLANS.map((p, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span style={{ fontSize: "0.82rem", fontWeight: 700, color: hasTicket ? "#10b981" : "#f1f5f9" }}>
                                            {hasTicket ? "0 Credits" : `${p.price.toLocaleString()} Cr`}
                                        </span>
                                        {active ? <Check /> : <div />}
                                    </div>
                                );
                ...
                <div style={{ ...card, padding: 24, position: "sticky", top: 24 }}>
                    ...
                    {/* Promo Code — hidden when using ticket */}
                    {!activeTicket && (
                    ...
                    <button onClick={handleDeploy} disabled={deploying} style={{
                        ...
                        background: deploying ? "#1d4ed8" : activeTicket ? "linear-gradient(135deg,#10b981,#059669)" : "linear-gradient(135deg,#3b82f6,#2563eb)",
                        color: "#fff", fontWeight: 800, fontSize: "0.95rem",
                        border: "none", cursor: deploying ? "not-allowed" : "pointer",
                        display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                        boxShadow: activeTicket ? "0 4px 20px rgba(16,185,129,0.35)" : "0 4px 20px rgba(59,130,246,0.35)",
                        transition: "all 0.15s",
                    }}>
                        {deploying ? (
