...
function SectionHeader({ icon, title, sub, t }: { icon: React.ReactNode; title: string; sub: string; t: ReturnType<typeof useThemeTokens> }) {
    return (
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
            <div style={{ width: 36, height: 36, borderRadius: t.buttonRadius, background: t.accentPrimaryMuted, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                {icon}
            </div>
            <div>
