...
export default function VPNDashboard() {
    ...
    const inputStyle: React.CSSProperties = {
        width: "100%", padding: "10px 14px", borderRadius: t.isMono ? 4 : 8,
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
                ...
                <button
                    ...
                    style={{
                        ...
                        padding: "9px 18px", borderRadius: t.isMono ? 4 : 8,
                            ...
                            <div key={peer.id} style={{
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        padding: "6px 12px", borderRadius: t.isMono ? 4 : 6,
                    ...
                    <div style={{ ...card, width: "100%", maxWidth: 440, padding: 32 }}>
                                ...
                                return (
                                    <button key={preset} onClick={() => setPeerName(preset)}
                                        style={{
                                            ...
                                            padding: "8px 0", borderRadius: t.isMono ? 4 : 8,
                        ...
                        <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                            <button onClick={() => { setShowCreate(false); setCreateError(""); }}
                                style={{ padding: "9px 18px", borderRadius: t.isMono ? 4 : 8, border: `1px solid ${t.borderPrimary}`, background: "transparent", color: t.textSecondary, cursor: "pointer", fontWeight: 600 }}>
                                Cancel
                            </button>
                            <button onClick={handleCreate} disabled={creating || !peerName.trim()}
                                style={{ padding: "9px 20px", borderRadius: t.isMono ? 4 : 8, border: "none", background: t.accentPrimary, color: t.textInverse, fontWeight: 700, cursor: "pointer", opacity: creating || !peerName.trim() ? 0.5 : 1 }}>
                    ...
                    <div style={{ ...card, width: "100%", maxWidth: 560, padding: 0, maxHeight: "90vh", overflow: "auto" }}>
                        ...
                        <div style={{ padding: "16px 28px 0", display: "flex", gap: 8 }}>
                            <button onClick={() => setShowQr(false)} style={{
                                padding: "6px 16px", borderRadius: t.isMono ? 4 : 6,
                        ...
                        <div style={{ padding: "16px 28px" }}>
                            {showQr ? (
                                ...
                                <pre style={{
                                    padding: 16, borderRadius: t.isMono ? 4 : 8,
                        ...
                        <div style={{ padding: "0 28px 24px", display: "flex", gap: 8, justifyContent: "flex-end" }}>
                            <button onClick={handleCopy} style={{
                                display: "flex", alignItems: "center", gap: 6,
                                padding: "9px 16px", borderRadius: t.isMono ? 4 : 8,
