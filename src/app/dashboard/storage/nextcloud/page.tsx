...
export default function NextcloudStoragePage() {
    ...
    return (
        <div style={{ padding: "32px 36px", minHeight: "100vh", backgroundColor: t.bgPrimary }}>
            ...
            {success && <div style={{ padding: "12px 16px", borderRadius: t.isMono ? 0 : 9, background: t.statusSuccessBg, border: `1px solid ${t.statusSuccess}33`, color: t.statusSuccess, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}><span style={{ display: "flex", alignItems: "center", gap: 6 }}><CheckCircle2 style={{ width: 14, height: 14, flexShrink: 0 }} /> {success}</span><button onClick={() => setSuccess("")} style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", display: "flex", alignItems: "center" }}><X style={{ width: 14, height: 14 }} /></button></div>}
            {error && <div style={{ padding: "12px 16px", borderRadius: t.isMono ? 0 : 9, background: t.statusErrorBg, border: `1px solid ${t.statusError}33`, color: t.statusError, marginBottom: 20, fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}><span style={{ display: "flex", alignItems: "center", gap: 6 }}><AlertCircle style={{ width: 14, height: 14, flexShrink: 0 }} /> {error}</span><button onClick={() => setError("")} style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", display: "flex", alignItems: "center" }}><X style={{ width: 14, height: 14 }} /></button></div>}
                                            ...
                                            <div>
                                                ...
                                                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                                    {(Object.keys(TIER_LABELS) as StorageType[]).map(tt => (
                                                        <label key={tt} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: t.isMono ? 0 : 8, border: `1px solid ${expandType === tt ? t.accentPrimary + "55" : t.borderPrimary}`, background: expandType === tt ? t.accentPrimaryMuted : "transparent", cursor: "pointer", transition: "all 0.15s" }}>
